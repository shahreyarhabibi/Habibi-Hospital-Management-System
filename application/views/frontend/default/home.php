        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="home-widget widget-3">
                    ...
                    <ul>
                        <li class="clearfix"><?php echo get_phrase('saturday');?> - <?php echo get_phrase('wednesday');?> 
                            <span class="float-right"><?php echo $open[0]->saturday_wednesday;?></span></li>
                        <li class="clearfix"><?php echo get_phrase('thursday');?>
                            <span class="float-right"><?php echo $open[0]->thursday;?></span></li>
                        <li class="clearfix"><?php echo get_phrase('friday');?>
                            <span class="float-right"><?php echo $open[0]->friday;?></span></li>
                    </ul>
                </div>
            </div>
        </div>
