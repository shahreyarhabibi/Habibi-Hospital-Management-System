    ...
    <div class="panel-body">
        ...
        <form action="<?php echo site_url('admin/frontend_settings/settings');?>" 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="saturday_wednesday"
                        value="<?php echo $open[0]->saturday_wednesday;?>">
                    <span class="description"><?php echo get_phrase('saturday').' - '.get_phrase('wednesday');?></span>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="thursday"
                        value="<?php echo $open[0]->thursday;?>">
                    <span class="description"><?php echo get_phrase('thursday');?></span>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="friday"
                        value="<?php echo $open[0]->friday;?>">
                    <span class="description"><?php echo get_phrase('friday');?></span>
                </div>
            </div>
