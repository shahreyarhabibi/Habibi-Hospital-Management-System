...
class Frontend_model extends CI_Model {
    ...
    function update_frontend_settings() {
        ...
        $opening_hours = array();
        $opening_hours_data['saturday_wednesday'] =  $this->input->post('saturday_wednesday');
        $opening_hours_data['thursday'] =  $this->input->post('thursday');
        $opening_hours_data['friday'] =  $this->input->post('friday');
